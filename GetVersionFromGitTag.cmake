...
if (GIT_FOUND AND VERSION_UPDATE_FROM_GIT)
	...
	execute_process(COMMAND ${GIT_EXECUTABLE} branch --format "%(refname:short)"
		WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
		OUTPUT_VARIABLE ${PROJECT_NAME}_BRANCH_NAME
		OUTPUT_STRIP_TRAILING_WHITESPACE)

	#How many commits since last tag
	execute_process(COMMAND ${GIT_EXECUTABLE} rev-list ${${PROJECT_NAME}_BRANCH_NAME} ${${PROJECT_NAME}_VERSION_STRING}^..HEAD --count
		WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
